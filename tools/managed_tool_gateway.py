...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "zaza.com"
...
def auth_json_path():
    """Return the ZAZA auth store path, respecting ZAZA_HOME overrides."""
    return get_zaza_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from zaza_cli.auth import resolve_nous_access_token
