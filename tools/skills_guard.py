...
Trust levels:
  - builtin:   Ships with ZAZA. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zaza/\.env|\~/\.zaza/\.env',
     "zaza_env_access", "critical", "exfiltration",
     "directly references ZAZA secrets file"),
    ...
    (r'\.zaza/config\.yaml|\.zaza/SOUL\.md',
     "zaza_config_mod", "critical", "persistence",
     "references ZAZA configuration files directly"),
