...
Built for [Agent ZAZA](https://github.com/ZAZA/agent-zaza). Usable in any coding agent. Canonical source lives here; synced to [`ZAZA/agent-zaza/skills/creative/ascii-video`](https://github.com/ZAZA/agent-zaza/tree/main/skills/creative/ascii-video) via PR.
