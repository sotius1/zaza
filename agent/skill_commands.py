...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.zaza.config``
    ...
    try:
        ...
        lines = ["", f"[Skill config (from {display_zaza_home()}/config.yaml):"]
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    """Scan ~/.agent-zaza/data/skills/ and return a mapping of /command -> skill info.
