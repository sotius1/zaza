...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_zaza_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.agent-zaza/data/config.yaml (primary user-facing config)
    3. ~/.agent-zaza/data/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_zaza_home()
    gw_data: dict = {}
