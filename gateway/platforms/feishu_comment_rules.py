...
Config: ~/.agent-zaza/data/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.agent-zaza/data/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zaza_home()`` helper (ZAZA_HOME-aware and
...
RULES_FILE = get_zaza_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zaza_home() / "feishu_comment_pairing.json"
