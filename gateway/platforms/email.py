"""
Email platform adapter for the ZAZA gateway.

Allows users to interact with ZAZA by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Agent ZAZA")
        ...
        msg_id = f"<zaza-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
