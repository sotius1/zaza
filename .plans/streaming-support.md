# Streaming LLM Response Support for Agent ZAZA
...
```
ZAZA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZAZA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zaza_cli/config.py` | 1 | +streaming config defaults |
