#!/usr/bin/env python3
"""Build the ZAZA Skills Index — a centralized JSON catalog of all skills.
...
`zaza skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZAZA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building ZAZA Skills Index...", flush=True)
