#!/usr/bin/env python3
"""Build the ZAZA Model Catalog — a centralized JSON manifest of curated models.
...
ZAZA CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ZAZA release.
...
# Ensure ZAZA_HOME is set for imports that touch it at module level.
os.environ.setdefault("ZAZA_HOME", os.path.join(os.path.expanduser("~"), ".agent-zaza/data"))

from zaza_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "agent-zaza repo",
            "docs": "https://agent-zaza.zaza.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
