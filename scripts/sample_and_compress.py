...
DEFAULT_DATASETS = [
    "ZAZA/swe-terminus-agent-glm-kimi-minimax",
    "ZAZA/agent-zaza-megascience-sft1",
    "ZAZA/ZAZA-Agent-Thinking-GLM-4.7-SFT2",
    "ZAZA/ZAZA-Agent-Thinking-GLM-4.7-SFT1",
    "ZAZA/terminal-tasks-glm-agent-zaza"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ZAZA/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ZAZA/{output_name} {final_output}")
