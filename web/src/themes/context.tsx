...
const STORAGE_KEY = "zaza-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zaza_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "zaza-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-zaza-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-zaza-theme-font", "true");
