 ...
 * `window.__ZAZA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the ZAZA brand in the top bar
 ...
 *  `window.__ZAZA_PLUGINS__.registerSlot(...)`.
 *
