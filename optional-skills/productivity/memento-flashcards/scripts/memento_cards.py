...
Data file: $ZAZA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZAZA_HOME = Path(os.environ.get("ZAZA_HOME", Path.home() / ".agent-zaza/data"))
DATA_DIR = _ZAZA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
