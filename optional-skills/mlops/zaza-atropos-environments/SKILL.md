---
name: zaza-atropos-environments
description: Build, test, and debug Agent ZAZA RL environments for Atropos training. Covers the ZAZAAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the agent-zaza repo.
version: 1.1.0
author: Agent ZAZA
license: MIT
metadata:
