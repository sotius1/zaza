...
Usage:
    zaza pairing list              # Show all pending + approved users
    zaza pairing approve <platform> <code>  # Approve a pairing code
    zaza pairing revoke <platform> <user_id> # Revoke user access
    zaza pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zaza pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zaza pairing {list|approve|revoke|clear-pending}")
        print("Run 'zaza pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'zaza pairing list' to see pending codes.\n")
