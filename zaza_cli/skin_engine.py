"""ZAZA CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.agent-zaza/data/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Agent ZAZA"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ ZAZA "       # Response box header label
...
.. code-block:: python
    ...
    from zaza_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Agent ZAZA"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.agent-zaza/data/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic ZAZA gold/kawaii (the current look)
...
Drop a YAML file in ``~/.agent-zaza/data/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZAZA_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZAZA_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "ZAZA native — cyber-green & violet, minimalist developer aesthetic",
        "colors": {
            # Cyber-green primary, violet accent, slate neutrals
            "banner_border": "#1f2937",        # subtle slate frame
            "banner_title": "#00ff88",         # cyber-green title
            "banner_accent": "#a855f7",        # violet section headers
            "banner_dim": "#64748b",           # slate dim
            "banner_text": "#e2e8f0",          # near-white body
            "ui_accent": "#00ff88",
            "ui_label": "#a855f7",
            "ui_ok": "#22c55e",
            "ui_error": "#ef4444",
        ...
        "spinner": {
            ...
            "thinking_faces": ["◐", "◓", "◑", "◒"],
            "thinking_verbs": [
                "thinking", "planning", "reasoning", "drafting",
                "weighing options", "tracing path", "considering",
            ],
        },
        "branding": {
            "agent_name": "ZAZA",
            "welcome": "ZAZA gotowa. Pisz wiadomość lub /help.",
    ...
    "legacy-gold": {
        "name": "legacy-gold",
        "description": "Klasyczny gold/kawaii (poprzedni default — dla nostalgii)",
        "colors": {
        ...
        "spinner": {},
        "branding": {
            "agent_name": "Agent ZAZA",
            "welcome": "Welcome to Agent ZAZA! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ ZAZA ",
            "prompt_symbol": "❯",
