"""
Skills configuration for Agent ZAZA.
`zaza skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.agent-zaza/data/config.yaml under:
...
from zaza_cli.config import cfg_get, load_config, save_config
from zaza_cli.colors import Colors, color
from zaza_cli.platforms import PLATFORMS as _PLATFORMS
