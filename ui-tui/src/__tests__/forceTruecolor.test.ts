...
const ENV_KEYS = ['COLORTERM', 'FORCE_COLOR', 'ZAZA_TUI_TRUECOLOR', 'NO_COLOR'] as const
...
describe('forceTruecolor', () => {
  ...
  it('respects ZAZA_TUI_TRUECOLOR=0 opt-out', async () => {
    await withCleanEnv(
      () => {
        process.env.ZAZA_TUI_TRUECOLOR = '0'
      },
      async () => {
