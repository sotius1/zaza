...
import type { ScrollBoxHandle } from '@zaza/ink'
import { evictInkCaches } from '@zaza/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZAZA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
