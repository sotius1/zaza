...
| | |
|---|---|
| Source | Optional — install with `zaza skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/ZAZA/agent-zaza/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/ZAZA/agent-zaza/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
