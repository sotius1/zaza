...
| | |
|---|---|
| Source | Optional — install with `zaza skills install official/health/neuroskill-bci` |
...
Connect ZAZA to a running [NeuroSkill](https://neuroskill.com/) instance to read
