...
| | |
|---|---|
| Source | Optional — install with `zaza skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Agent ZAZA"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.agent-zaza/data/.env`:
...
```bash
CANVAS="python $ZAZA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
