...
| | |
|---|---|
| Source | Optional — install with `zaza skills install official/research/qmd` |
...
Agent ZAZA via the native MCP client. This is the preferred
...
Then configure Agent ZAZA to connect via HTTP:
