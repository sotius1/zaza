---
title: "Agent ZAZA"
sidebar_label: "Agent ZAZA"
description: "Complete guide to using and extending Agent ZAZA — CLI usage, setup, configuration, spawning additional agents, gateway platforms, skills, voice, tools, pr..."
---
...
Complete guide to using and extending Agent ZAZA — CLI usage, setup, configuration, spawning additional agents, gateway platforms, skills, voice, tools, profiles, and a concise contributor reference. Load this skill when helping users configure ZAZA, troubleshoot issues, spawn agent instances, or make code contributions.
...
| Path | `skills/autonomous-ai-agents/agent-zaza` |
| Version | `2.0.0` |
...
zaza skills install ID    Install a skill
