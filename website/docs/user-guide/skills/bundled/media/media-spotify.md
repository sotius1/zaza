...
Control the user's Spotify account via the ZAZA Spotify toolset (7 tools). Setup guide: https://agent-zaza.zaza.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `zaza auth spotify` again.
