...
| Version | `1.1.0` |
| Author | Agent ZAZA (adapted from obra/superpowers) |
| License | MIT |
...
> **For ZAZA:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use ZAZA tools to understand the project:
