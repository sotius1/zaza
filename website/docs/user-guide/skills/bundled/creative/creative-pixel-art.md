...
```python
import sys
sys.path.insert(0, "/home/teknium/.agent-zaza/data/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.agent-zaza/data/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — ZAZA installs package this)
