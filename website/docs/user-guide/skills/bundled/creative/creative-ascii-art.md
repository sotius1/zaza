...
```bash
python3 -m pyfiglet "ZAZA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ZAZA&font=Slant" | boxes -d stone
```
