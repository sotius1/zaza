...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from zaza_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZAZA_OVERLAYS
        overlay = ZAZA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify zaza doctor recognizes Xiaomi env vars."""
