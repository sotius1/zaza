"""Tests for zaza_cli.auth._update_config_for_provider clearing stale fields.
...
from zaza_cli.auth import _update_config_for_provider
...
class TestUpdateConfigForProviderClearsStaleCustomFields:
    ...
    def test_switching_to_nous_clears_stale_api_mode(self):
        _seed_custom_provider_config()
        _update_config_for_provider("nous", "https://inference-api.zaza.com/v1")
        model_cfg = _read_model_cfg()
