"""Tests for the interactive session browser (`zaza sessions browse`).
...
from zaza_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zaza sessions browse should be parseable."""
        from zaza_cli.main import main as _main_entry
