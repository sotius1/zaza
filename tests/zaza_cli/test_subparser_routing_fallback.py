...
The main() function in zaza_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zaza -c model`
...
def _build_parser():
    """Build a minimal replica of the zaza top-level parser."""
