...
def curator_env(tmp_path, monkeypatch):
    """Isolated ZAZA_HOME + freshly reloaded curator + skill_usage modules."""
...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    """zaza curator unpin must refuse bundled/hub skills too (matches pin)."""
    from zaza_cli import curator as cli
    skills_dir = curator_env["home"] / "skills"
