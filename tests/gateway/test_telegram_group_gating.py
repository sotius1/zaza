...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @zaza_bot", entities=[_mention_entity("hi @zaza_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@zaza_bot",
            entities=[_bot_command_entity("/status@zaza_bot", "/status@zaza_bot")],
        ),
        is_command=True,
    ) is True
