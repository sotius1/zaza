...
def test_import_loads_env_from_zaza_home(tmp_path, monkeypatch):
    home = tmp_path / ".agent-zaza/data"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-zaza-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-zaza-home"
