...
def _reload_constants():
    """Reload zaza_constants to get a fresh apply_ipv4_preference."""
    import zaza_constants
    importlib.reload(zaza_constants)
    return zaza_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_zaza_ipv4_patched", False) is True
