...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host ZAZA_REDACT_SECRETS."""
    monkeypatch.delenv("ZAZA_REDACT_SECRETS", raising=False)
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        from tools.browser_tool import browser_navigate
        result = browser_navigate("https://github.com/ZAZA/agent-zaza")
        parsed = json.loads(result)
