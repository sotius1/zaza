...
class TestParserRegistry:
    ...
    def test_zaza_parser_registered(self):
        parsers = list_parsers()
        assert "zaza" in parsers
...
class TestZAZAParser:
    @pytest.fixture
    def parser(self):
        return get_parser("zaza")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["zaza"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use zaza format since that's universal
