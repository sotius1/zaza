#!/usr/bin/env python3
"""
SWE Runner with ZAZA Trajectory Format

A runner that uses ZAZA-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ZAZA-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ZAZA-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ZAZA format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ZAZA-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ZAZA-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ZAZA Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ZAZA-Agent's built-in execution environments
    and outputs trajectories in ZAZA-Agent format.
    """
    ...
    def _convert_to_zaza_format(
        ...
        """
        Convert internal message format to ZAZA trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ZAZA trajectory format
        trajectory = self._convert_to_zaza_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with ZAZA trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ZAZA Trajectory Format")
    print("=" * 60)
