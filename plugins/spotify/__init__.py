...
``_check_spotify_available()`` — when the user has not run ``zaza auth
spotify``, the tools remain registered (so they appear in ``zaza
...
The Spotify auth flow (``zaza auth spotify``), CLI plumbing, and docs
