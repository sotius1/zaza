"""
Monkey patches for making agent-zaza tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by zaza_base_env.py).
