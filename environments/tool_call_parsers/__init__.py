...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("zaza")
        class ZAZAToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "zaza", "mistral", "llama3_json")
...
from environments.tool_call_parsers.zaza_parser import ZAZAToolCallParser  # noqa: E402, F401
