...
Inspired by: GroceryMind — production ZAZA agent doing live web research
             across German grocery stores (firecrawl + agent-zaza)
"""
...
# Ensure agent-zaza root is on path
...
class WebResearchEnvConfig(ZAZAAgentEnvConfig):
...
class WebResearchEnv(ZAZAAgentBaseEnv):
    """
