...
- **Dataset (ours):** [ZAZA/openthoughts-tblite](https://huggingface.co/datasets/ZAZA/openthoughts-tblite)
- **Docker images:** `zaza/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `ZAZA/terminal-bench-2`  | `ZAZA/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
