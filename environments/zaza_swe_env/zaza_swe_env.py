"""
ZAZASweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser zaza
    run-api
    python environments/zaza_swe_env.py serve \\
...
class ZAZASweEnv(ZAZAAgentBaseEnv):
    ...
    name = "zaza-swe"
    env_config_cls = ZAZASweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ZAZASweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = ZAZASweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="ZAZA/DeepZAZA-3-Llama-3-3B-Preview",
            tool_call_parser="zaza",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="zaza-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="ZAZA/DeepZAZA-3-Llama-3-3B-Preview",
