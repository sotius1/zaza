...
ALL agent-zaza tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all agent-zaza tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any agent-zaza tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("ZAZA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("ZAZA_QUIET", None)
            else:
                os.environ["ZAZA_QUIET"] = _prev_quiet
